...
CREATE TABLE cue_user_registrations (
...
CREATE INDEX idx_cue_user_registrations_source_period
  ON cue_user_registrations(source_id, period, subject_hash);

CREATE TABLE cue_user_active_days (
  org_id        INTEGER NOT NULL REFERENCES orgs(id) ON DELETE CASCADE,
  source_id     TEXT NOT NULL REFERENCES cue_sources(id) ON DELETE CASCADE,
  period        TEXT NOT NULL,
  subject_hash  TEXT NOT NULL,
...
CREATE INDEX idx_cue_user_active_days_source_subject_period
