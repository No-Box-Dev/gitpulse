/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f354e5aa76071865fb7eaba91d169743)
...
interface __BaseEnv_Env {
	...
	RATE_LIMITER: DurableObjectNamespace<import("./src/index").NoxSpotRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "NoxSpotRateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_API_BASE_URL" | "PUBLIC_ASSET_BASE_URL" | "WIDGET_VERSION">> {}
}
